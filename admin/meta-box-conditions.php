    ...
    function __construct() {
        ...
        $this->add_field_group( 'conditions', array(
            'menu-rules-conditional-exp' => array(
                ...
                'description' => '
                    <p>' . sprintf( __( 'A full list of conditonal tags can be %sfound on the WordPress.org codex%s.' ), '<a href="http://codex.wordpress.org/Conditional_Tags" target="_blank">', '</a>' ) . '</p>
                    <p>' . __( 'Do not include an if statement or a semicolon.' ) . '</p>
                ',
                'footer' => '
                    <h4>' . __( 'Examples' ) . '</h4>
