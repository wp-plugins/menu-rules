...
class Menu_Rules {
    ...
    static function init() {
        ...
        register_post_type( self::get_var( 'post_type' ), array(
            'labels' => array(
                'name' => _x('Menu Rules', 'post type general name'),
                'singular_name' => _x('Menu Rule', 'post type singular name'),
                'add_new' => _x('Add New', 'Menu Rule'),
                'add_new_item' => __('Add New Menu Rule'),
                'edit_item' => __('Edit Menu Rule'),
                'new_item' => __('New Menu Rule'),
                'view_item' => __('View Menu Rule'),
                'search_items' => __('Search Menu Rules'),
                'not_found' =>  __('No Menu Rules found'),
                'not_found_in_trash' => __('No Menu Rules found in Trash'),
            ),
            'public' => false,
